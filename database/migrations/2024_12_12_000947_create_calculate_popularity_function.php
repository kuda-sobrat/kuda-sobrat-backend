    ...
    public function up(): void
    {
        ...
        BEGIN
            ...
            SELECT
                ...
                COALESCE(MAX(CASE WHEN param_name = 'archived_decay_coefficient' THEN param_value END), 0.05),
            ...
            -- Проверяем, заархивировано ли событие
            SELECT is_archived, archived_at INTO v_is_archived, v_archived_at FROM events WHERE id = p_event_id;
            ...
            IF v_is_archived = TRUE THEN
                -- Если событие заархивировано, увеличиваем коэффициент затухания
                SET v_age_factor = EXP(-v_archived_decay_coeff * v_age_hours);
            ELSE
